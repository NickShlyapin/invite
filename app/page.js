...
import Img1 from "../assets/2023-07-06 02.29.38.jpg";
    ...
    <main className={styles.main}>
      ...
      <div className={styles.dresscode}>
        ...
        <div className={styles.info}>
          ...
          <br />
          <p>
            Для мужчин подойдет темный костюм или смокинг, белая рубашка и
            ненавязчивый галстук.
          </p>
          <br />
          <div className={styles.imgCont}>
          ...
          <br />
          <p>
            Женщинам необходимо подобрать классическое платье любой длины или
            раздельный верх и низ – блузка, юбка или брюки.
          </p>
          <br />
          <div className={styles.imgCont}>
      ...
      <div className={styles.gift}>
        <div>
          <hr />
          <h2>Подарки</h2>
          <p>Мы копим на мечту и будем рады вашему вкладу в ее осуществление</p>
        </div>
        <div>
          <hr />
          <h2>Цветы</h2>
        ...
        <div>
          ...
          <h2>Сладко!</h2>
          <p>
            Именно так мы бы хотели, чтобы прошло наше торжество и началась
            семейная жизнь! Для нас поцелуй - это очень интимный момент, поэтому
            будем признательны, если вы откажетесь от криков Горько.
          </p>
        </div>
      </div>
